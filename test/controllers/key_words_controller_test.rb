...
class KeyWordsControllerTest < ActionController::TestCase
  ...
  test "should create key_word" do
    assert_difference('KeyWord.count') do
      post :create, key_word: { name: @key_word.name, pattern_type_id: @key_word.pattern_type_id }
    end
  ...
  test "should update key_word" do
    patch :update, id: @key_word, key_word: { name: @key_word.name, pattern_type_id: @key_word.pattern_type_id }
    assert_redirected_to key_word_path(assigns(:key_word))
  end
